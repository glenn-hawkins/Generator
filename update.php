...
function addBook() {
	addWindow = window.open('addbook.php', '_blank', 'height=200,width=575');
	addWindow.focus();
}
...
<br />
            <form action="" id="updateForm">
                ...
                <img src="addIcon.jpg" alt="add a book" onmouseover="this.src='addIcon2.jpg'" onmouseout="this.src='addIcon.jpg'" onclick="addBook()" />
                <select id="chapterSelect" name="chapterSelect" disabled="true" onchange=
                	"enableTextInput()">
                  <option selected="selected">Select Chapter</option>
                </select>
                <img src="addIcon.jpg" alt="add a chapter" onmouseover="this.src='addIcon2.jpg'" onmouseout="this.src='addIcon.jpg'" onclick="addChapter()"  />
                <br /><br />
                漢字：
